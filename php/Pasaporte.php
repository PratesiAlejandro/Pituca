...
$nombre = $_FILES['passport']['name'];
$tipo = $_FILES['passport']['type'];
$tamanio = $_FILES['passport']['size'];
$ruta = $_FILES['passport']['tmp_name'];
...
if (file_exists($destino)) {
   ...
   $objUsuario->ArDetalle = "Pasaporte";
   $objUsuario->ArNombre = $nombre;
   $objUsuario->ArTipo = "JPG";
