...
$nombre = $_FILES['proof']['name'];
$tipo = $_FILES['proof']['type'];
$tamanio = $_FILES['proof']['size'];
$ruta = $_FILES['proof']['tmp_name'];
...
if (file_exists($destino)) {
   ...
   $objUsuario->ArDetalle = "University Proof";
