...
$nombre = $_FILES['workfun']['name'];
$tipo = $_FILES['workfun']['type'];
$tamanio = $_FILES['workfun']['size'];
$ruta = $_FILES['workfun']['tmp_name'];
$destino = "../archivos_subidos/".$nombre;


if (file_exists($destino)) {
    echo "<div class='alert alert-danger' role='alert'>
          <strong>Error !!!</strong> Existe un archivo con el mismo nombre.
          </div>";
